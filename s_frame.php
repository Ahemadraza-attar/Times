...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="s_insert.php" method="post" enctype="multipart/form-data">
    <div class="container">
...
<h3 style="text-align: center; color: #474e5d">Software Projects</h3><hr> -->
...
$sqli = "SELECT id, title, image FROM software";
...
<a href="s_update.php?$id=<?php echo $row['id']; ?>">Update</a> </td><td>
<a href="s_delet.php?$id=<?php echo $row['id']; ?>">Delete</a> 
