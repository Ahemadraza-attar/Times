...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="el_insert.php" method="post" enctype="multipart/form-data">
    <div class="container">
	...
	<label"><b>File</b></label>
      <input type="file" placeholder="Insert file" name="elfile" required><br>
...
$sqli = "SELECT id, title, image FROM electronic";
...
<a href="el_update.php?$id=<?php echo $row['id']; ?>">Update</a> </td><td>
<a href="el_delet.php?$id=<?php echo $row['id']; ?>">Delete</a> 
