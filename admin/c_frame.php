...
$sqli = "SELECT id, name, email, number, subject FROM contact";
$result = mysqli_query($conn, $sqli);


echo "<table><tr><th>ID</th><th>Name</th><th>Email id</th><th>Number</th><th>Subject</th><th>Delete</th></tr>";
...
if (mysqli_num_rows($result) > 0) {
 ...
 echo "<tr><td>" . $row["id"]. "</td><td>" . $row["name"]. "</td><td>" . $row["email"]. "</td><td>" . $row["number"]. "</td><td>" . $row["subject"]. "</td><td>";
?>

<a href="c_delet.php?$id=<?php echo $row['id']; ?>">Delete</a> 
